...
- 🎨 **现代 UI** - 基于 React 18 构建的响应式界面，支持明暗主题切换
...
| **前端框架** | [React 18](https://reactjs.org/) + TypeScript |
| **构建工具** | [Vite 7](https://vitejs.dev/) |
| **状态管理** | [Zustand](https://zustand-demo.pmnd.me/) |
...
```
~/.config/music-player/sources.json   # Linux
~/Library/Application Support/music-player/sources.json  # macOS
%APPDATA%\music-player\sources.json   # Windows
```
...
![播放页面截图](./screenshots/player.png)

### 搜索页面

![搜索页面截图](./screenshots/search.png)
...
- [提交 Bug](https://github.com/your-org/music-player/issues/new?template=bug_report.md)
- [功能建议](https://github.com/your-org/music-player/issues/new?template=feature_request.md)
